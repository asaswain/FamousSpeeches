...
/**
 * This class displays the speech player activity screen
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    */
    ...
    private void loadWikipediaPage(Speech mySpeech) {
        ...
        final ProgressDialog progressBar = ProgressDialog.show(MainActivity.this, loadingTitle, loadingMessage);
